...
for directory_path in glob.glob("C:/Users/Aayush1999/Desktop/ACE/Final Year Project/Cancer Care/Implementation/Dataset/Test Cases/"):
...
def gabor_filter(dataset):
    ...
    for image in range(dataset.shape[0]):
        ...
        temp = label_name[i]
        #print(temp)
        cv2.imwrite('C:/Users/Aayush1999/Desktop/ACE/Final Year Project/Cancer Care/Implementation/Dataset/Test Cases Filtered/' + temp, img)
